...
ဆေးကြောပါ။ နေမကောင်းဖြစ်၍ ကျန်းမာရေးစောင့်ရှောက်မှုပေးသူနှင့် မပြသသေးမီ အိမ်တွင်
...
<List.Accordion
        title="မျက်ဝတ်ထွက်ခြင်း" titleNumberOfLines={20} style={{backgroundColor:"#bcc3e5"}} theme={{colors:{primary:'#8e61ff'}}}
        >
...
•	သို့သော် အရက်၊ ဆေးလိပ်နှင့် ဘိန်းမှ ထုတ်သော မူးယစ်ဆေး (သို့) ဘိန်းပါသော ချောင်းဆိုးပျောက်ဆေးများမှာမူ အန္တရာယ်ရှိသဖြင့် ရှောင်ကြဉ်သင့်ပါသည်။`}
titleNumberOfLines={200}/>
      </List.Accordion>

      <List.Accordion
        title="ဖျားနာသောကလေးကို အိမ်တွင်ပြုစုခြင်း" titleNumberOfLines={20} style={{backgroundColor:"#bcc3e5"}} theme={{colors:{primary:'#8e61ff'}}} >
        <List.Item title={`•	အမြဲလိုက်နာရန် အချက်များအပြင် ကိုယ်အပူချိန်များပါက ရေစိုဝတ် (ရေရိုးရိုး) ဖြင့် တကိုယ်လုံးရေပတ်တိုက်ပေးပါ။
•	အဝတ်ပါးပါး ၀တ်ပေးပါ။
•	လေကောင်းလေသန့်ရသော၊ လေဝင်လေထွက်ကောင်းသော နေရာတွင်ထားပါ။ မက်ကလောင် မဖေါက်ပါနှင့်။`}
titleNumberOfLines={200}/>
        </List.Accordion>

<List.Accordion
        title="ဝမ်းပျက်ဝမ်းလျှောဖြစ်နေသော ကလေးကို အိမ်တွင်ပြုစုခြင်း" titleNumberOfLines={20} style={{backgroundColor:"#bcc3e5"}} theme={{colors:{primary:'#8e61ff'}}}
        >
        <List.Item title={`•	အမြဲလိုက်နာရန် အချက်များအပြင် ကလေးအား ခါတိုင်းထက် အရည်ပိုတိုက်ပါ။
•	ဓာတ်ဆားရည်၊ ထမင်းရည်၊ ဆန်ပြုတ်၊ စွပ်ပြုတ်၊ လတ်ဆတ်သော သစ်သီးဖျော်ရည်၊ ရေနွေးကြမ်း၊ ရေ၊ အုန်းစိမ်းရည် တိုက်ကျွေးနိုင်သည်။
•	ကလေးသောက်နိုင်သမျှ ၀မ်းရပ်သွားသည်အထိ အရည်ဆက်တိုက်နေရန် လိုပါသည်။
...
•	အကယ်၍ အန်ပါက ၁၅ မိနစ်ခန့်နားပြီး အထက်ဖော်ပြပါ ပမာဏကုန်စေရန် ခဏ၊ ခဏ ခွဲတိုက်ပေးပါ။
•	အကယ်၍ ဓာတ်ဆားထုပ်မရှိပါက ရေကျက်အေး ၁ လီတာတွင် ဆား လဘက်ရည်ဇွန်း တစ်ဝက်ခန့်နှင့် သကြား လဘက်ရည်ဇွန်း ၈ ဇွန်း (ဇွန်းတွင်မောက်နေအောင် မထည့်ရပါ) ထည့်ပြီး သမအောင် မွှေပြီး အထက်ဖော်ပြပါအတိုင်း တိုက်ကျွေးနိုင်ပါသည်။`}
titleNumberOfLines={200}/>
      </List.Accordion>
