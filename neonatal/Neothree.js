    ...
    navigation.goBack()
     ...
     return(
       <ScrollView style={{backgroundColor:'#D1D9FF'}}>
         ...
         (ဂ) ၅နှစ်အောက်ကလေး၏ အထွေထွေအန္တရာယ်လက္ခဏာများ 
         </Text>
         <Text style={styles.p}>
         <Text style={styles.subpp}>ကလေးတွင် အောက်ပါလက္ခဏာများ တွေ့ရှိပါက အနီးစပ်ဆုံး ဆေးရုံ/ ဆေးခန်းသို့ အလျင်မြန်ဆုံး/ ချက်ချင်း ခေါ်ဆောင်သွားရပါမည်။ 
</Text>
