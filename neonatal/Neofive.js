    ...
    navigation.goBack()
     ...
     return(
       <ScrollView  style={{backgroundColor:'#D1D9FF'}}>
         ...
         {"\n"}•	ထိုကဲ့သို့ ပြုမူပေးခြင်းဖြင့် ကာယ၊ ဉာဏဖွံ့ဖြိုး၍ ဉာဏ်ရည်ထက်မြက်သော ကလေး ငယ်များ ဖြစ်လာမည်ဖြစ်သည်။
         ...
         {"\n"}•	ကလေးကစားရာတွင် ဘေးအန္တရာယ်ကင်းရန် အရေးကြီးသဖြင့် ကလေးကစားသည့် အနီးတဝိုက်တွင် ထိခိုက်ဒဏ်ရာရစေနိုင်သောပစ္စည်းများ မရှိစေရန် ရှင်းလင်းထား ရမည်။
         {"\n"}•	မိဘများသည် ကလေးကို အန္တရာယ်ကင်းသော ကစားစရာများဖန်တီးပေးခြင်း၊ ကလေးနှင့် အတူကစားခြင်း၊ ကလေးကိုယ်တိုင် ကြိုးစားရန် အခြေအနေဖန်တီးပေး ခြင်းတို့ကို ဆောင်ရွက်ပေးရမည်။
...
အောက်ပါအချက်များမှ တစ်ခုရှိပါကဆေးရုံ/ဆေးခန်း/ကျန်းမာရေးဌာနများသို့ အမြန်ဆုံး သွားရောက်ပြသပါ။
    ...
    <List.Accordion
          ...
          >
          <List.Item title={`မိခင်မျက်နှာ (သို့) အရာဝတ္ထုတို့ကို လိုက်၍မကြည့်ခြင်း၊ အသံပေးသော် လည်း အပြုအမူ မပြောင်းလဲခြင်း၊ မြှူးလျှင် ပြုံးမပြတက်ခြင်း၊ ကိုယ်ခန္ဓာ လွန်စွာ တောင့်ခြင်း (သို့) ပျော့ခြင်း။`}
        ...
        <List.Accordion
          ...
          >
          <List.Item title={`လက်သီးအမြဲဆုပ်ထားခြင်း။ခေါင်းမခိုင်ခြင်း။အရုပ်တစ်ခုခုကိုမကိုင်နိုင်ခြင်း။`}
  titleNumberOfLines={200}/>
        </List.Accordion>
  ...
  titleNumberOfLines={200}/>
          ...
          <List.Item title={`ယခင်ရှိပြီးတက်ပြီးသားကလေးဖွံ့ဖြိုးတိုးတက်မှုများပျောက်ဆုံးသွားခြင်း(သို့) ဆုတ်ယုတ်လာခြင်း၊ ယခင်ပြောတတ်သောစကားများပြန်ပျောက်သွားခြင်း။`}
  titleNumberOfLines={200}/>
          </List.Accordion>
