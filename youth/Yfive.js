...
export default function YFive({navigation}) {
    ...
    navigation.goBack()
     ...
     return(
       <ScrollView style={{backgroundColor:'#FFCCCB'}}>
         ...
         (င) သားဆက်ခြားခြင်း ( အသေးစိတ်အချက်အလက်များ / အရေးပေါ် သားဆက်ခြားခြင်း ) 
         </Text>
  ...
  <List.Accordion
        title="လတ်တလောကိုယ်ဝန် ရှိ" titleNumberOfLines={20} style={{backgroundColor:"#e5b7b6"}} theme={{colors:{primary:'#8e61ff'}}}
        >
...
titleNumberOfLines={200}/>
        ...
        >
        <List.Item title={`ဟော်မုန်းပါသည့် သားဆက်ခြားသောက်ဆေးများ မသုံးရန်။ ၃လခံဆေးဖြစ်နိုင်ပါက မသုံးရန်။ ပရိုဂျက်စတီရုန်း တစ်မျိုးတည်းပါ သားဆက်ခြားနည်း သုံးနိုင် ။ ကွန်ဒုံးသုံးနိုင်။`}
        titleNumberOfLines={200} />
      </List.Accordion>
...
titleNumberOfLines={200}/>
      ...
      <List.Accordion
        title="ခေါင်းပြင်းထန်စွာ ကိုက်သည့် ရောဂါရှိသူ" titleNumberOfLines={20} style={{backgroundColor:"#e5b7b6" }}  theme={{colors:{primary:'#8e61ff'}}}
        >
        <List.Item title={`ဟော်မုန်းပါသည့် သားဆက်ခြားသောက်ဆေးများ မသုံးရန်။ ပရိုဂျက်စတီရုန်း တစ်မျိုးတည်းပါ သားဆက်ခြားနည်း သုံးနိုင် ။ ကွန်ဒုံးသုံးနိုင်။`}
titleNumberOfLines={200}/>
      </List.Accordion>
...
<List.Accordion
        ...
        >
        <List.Item title={`အကာအကွယ်မဲ့ လိင်ဆက်ဆံခြင်းဖြင့် ကိုယ်ဝန်ရနိုင်သည့်အတွက် နှစ်သိမ့်ပညာပေး ဆွေးနွေးပါ။ အရေးပေါ် သန္ဓေတား စားဆေးသောက်ရန် နောက်ကျခြင်းသည် ဆေးအာနိသင် ကျဆင်းစေသဖြင့် အရေးပေါ် သန္ဓေတား စားဆေး စောလျှင်စွာ သောက်ရန်လိုအပ်သည်။ အရေးပေါ် သန္ဓေတား စားဆေးသည် ၅ရက် (၁၂၀ နာရီ) ကျော်လျှင် ထိရောက်မှု မရှိတော့ပါ။ ဘေးထှကျဆိုူကြိုးအဖွဈ ဆေးသောက်ပြီး အန်တတ်သည်။ အအန်သက်သာစေရန် antiemetic ဆေးသောက်နိုင်သည်။ အရေးပေါ် သန္ဓေတား စားဆေး နှစ်မျိုးရှိသည်။ 
...
	ကိုယ်ဝန်မရရန် သန္ဓေတားဆေး သုံးစွဲလိုပါက ကျန်းမာရေးဝန်ထမ်းများ နှင့် ဆွေးနွေးမှု ခံယူရန် အကြံပြုပါ။ (MOHS, 2015)`}
        titleNumberOfLines={200} />
      </List.Accordion>
