...
export default function Deli({navigation}) {
    ...
    navigation.goBack()
     ...
     return(
      ...
      <Text style={styles.p}> 
      {"\u00a0\u00a0\u00a0\u00a0\u00a0\u00a0"}နီးစပ်ရာကျန်းမာရေးဌာန၊ ကျန်းမာရေးဌာနခွဲများတွင် မွေးဖွားရန်လိုအပ်သည့် သန့်စင်ပြီး (၆) မျိုးသည် ပြီးပြည့်စုံပြီးဖြစ်ပါသဖြင့် ကျန်းမာရေးဌာများတွင် သွားရောက် မွေးဖွားသင့်ပါသည်။ အကယ်၍ မသွားရောက်နိုင်ပါက အောက်ပါ သန့်စင်ခြင်း (၆) မျိုး လိုအပ်ပါသည်။
      ...
      {"\n"}<Text style={styles.subtitle}>
      (ခ) မွေးဖွားစဥ်အတွင်း ဖြစ်ပေါ်နိုင်သည့် အန္တရာယ်လက္ခဏာများ 
      </Text>
