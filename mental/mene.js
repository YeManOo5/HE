    ...
    navigation.goBack()
     ...
     return(
       <ScrollView style={{backgroundColor:'#FFDDC1'}}>
         ...
         <Text style={styles.p}>
         {"\n"}•	မိမိကိုယ်ကို သေကြောင်းကြံစည်ခြင်းသည် အရေးပေါ်စိတ်ကျန်းမာရေး အခြေအနေပင် ဖြစ်ပါသည်။
         {"\n"}•	သေကြောင်းကြံစည်လိုကြောင်း ပြောသူများကို လျစ်လျူရှုမထားပါနှင့်၊ သေကြောင်းကြံစည်ရန် ကြိုးစားမှုများသည် မတော်တဆအောင်မြင်သွားတတ်ကြောင်း သတိပြုပါ။
         {"\n"}•	ငြိမ်သက်လွန်းခြင်း၊ နှေးကွေးလေးလံခြင်း၊ ရှောင်ဖယ်နေတတ်ခြင်း၊ အားငယ်နေပြီး သေလိုသောဆန္ဒများကို ထုတ်ဖော်ပြောဆိုခြင်းများသည် မိမိကိုယ်ကို သေကြောင်းကြံစည်နိုင်ရန် အလားအလာများစွာရှိသူများ ဖြစ်ပါသည်။
