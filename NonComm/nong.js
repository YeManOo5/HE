    ...
    navigation.goBack()
     ...
     return(
       <ScrollView  style={{backgroundColor:'#F8FFD7'}}>
         ...
         <Text style={styles.p}>{"\u00a0\u00a0\u00a0\u00a0\u00a0\u00a0"}
         ပန်းနာရင်ကျပ်ရောဂါဆိုသည်မှာ အသက်ရှူလမ်းကြောင်းနှင့် လေပြွန်များရောင်ရမ်းပြီး သာမန်ထက်ပို၍ တုန့်ပြန်မှု များပြားမြန်ဆန်နေခြင်းဖြစ်သည်။
         </Text>
         <List.Accordion
...
•	ဆေးလိပ်သောက်ခြင်း
•	လေထုညစ်ညမ်းမှုများ
•	ကပ်ပါးရောဂါနှင့် အခြားအသက်ရှူလမ်းကြောင်းဆိုင်ရာ ကူးစက်ရောဂါများ
•	ပန်းနာဖြစ်စေသော ဆေးဝါးသောက်သုံးမှုများ`}
      ...
      <List.Accordion
        ...
        >
        <List.Item title={`•	အသက်ရှူစဉ် ရွှီရွှီမြည်ခြင်း
