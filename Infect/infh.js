    ...
    navigation.goBack()
     ...
     return(
       <ScrollView style={{backgroundColor:'#D7FFD9'}}>
         ...
         <Text style={styles.p}>
         ဆင်ခြေထောက်ရောဂါဆိုသည်မှာ သွေးကြောထဲတွင်နေသော သန်ကောင်အမျိုးအ စားပိုးတစ်မျိုးကြောင့် ဖြစ်ပွားသည်။ ရောဂါဖြစ်ပွားသည့် သန်ကောင်အမျိုးအစားပိုး သယ် ဆောင်ထားသော ကျူးလက်(စ်)ခြင် ကိုက်ခြင်းဖြင့် ကူးစက်ပါသည်။
...
{"\n"}•	ခြေ၊ လက်တစ်ဖက်/ နှစ်ဖက် နီရဲ၊ ပူလောင်၊ ရောင်ရမ်း၍နာခြင်း (မှင်ထခြင်း၊ ပင့်ကူ ရှပ်ခြင်းနှင့် ဆင်တူသော)
...
{"\n"}၂။	ခြင်ပေါက်ပွားရာနေရာများဖြစ်သည့် ရေစီးရေလာမကောင်းသည့် ရေမြောင်း ပုပ်များ၊ ရေးဆိုးကျင်းများနှင့် မလုံခြုံသော အိမ်သာကျင်းများကို ရှင်းလင်းဖယ်ရှား ခြင်းဖြင့် ကာကွယ်နိုင်ပါသည်။
